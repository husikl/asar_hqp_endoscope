...
#         # print("res manager init start ...")
#         self.current_image = None
#         self.current_mask = None
#         self.processor =processor
#         self.num_obj = None
#         # print("res manager init complete ...")
...
#         self.current_prob = mask[:,0].float()#index_numpy_to_one_hot_torch(self.current_mask, self.num_objects+1).cuda()
